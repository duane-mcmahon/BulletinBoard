...
<div id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('User.user_id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('User.user_id'))); ?></li>
        <li><?php echo $this->Html->link(__('View Users', true), array('action' => 'index')); ?></li>
