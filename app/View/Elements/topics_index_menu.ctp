...
<div id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li><?php echo $this->Html->link(__('Create a Topic', true), array('action' => 'add')); ?> </li>
        <li><?php echo $this->Html->link(__('View Categories', true), array('controller' => 'categories', 'action' => 'index')); ?> </li>
